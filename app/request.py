...
def process_results(movie_list):
    '''
    function to process movie results and transforms them t a list of objects
    ...
    for movie_item in movie_list:
        ...
        vote_count = movie_item.get('vote_cunt')
...
def get_movie(id):
    '''
    functin to get json response to our url on movie details
    '''
